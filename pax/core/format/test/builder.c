...
main(int argc, char** argv)
{
    ...
    PxBuilder builder = pxBuilderReserve(&arena, 30);
    ...
    size = pxBuilderChain(&builder, 0, 5, (PxFormatCmd[]) {
        ...
        pxFormatCmdInteger(10, PX_FORMAT_FLAG_LEADING_PLUS, PX_IWORD_MAX),
        pxFormatCmdString8(pxs8(", y = ")),
        pxFormatCmdInteger(10, PX_FORMAT_FLAG_NONE, PX_IWORD_MIN),
